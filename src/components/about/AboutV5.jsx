                            ...
                            <div className="about-content pl-70 rpl-0">
                                ...
                                <div className="feature-item">
                                    ...
                                    <div className="feature-content">
                                        ...
                                        <p>We create high-quality, scalable, and innovative websites tailored to your business needs.</p>
                                    </div>
                                </div>
                                <div className="feature-item">
                                    <div className="icon">
                                    ...
                                    <div className="feature-content">
                                        ...
                                        <p>Protect your digital assets with our advanced cybersecurity 
                                            services and secure infrastructure.</p>
                                    </div>
                                </div>
