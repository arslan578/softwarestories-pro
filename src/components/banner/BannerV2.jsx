                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="hero-content text-white pt-100 pb-200 rpt-40 rpb-100">
                                <span className="sub-title d-block wow fadeInUp delay-0-2s">  Transform Your Business with Technology</span>
                                <Fade className="fadeInUp delay-0-4s">
                                    <h1 className="mt-20"> Innovative IT Solutions for Your Growth</h1>
                                </Fade>
