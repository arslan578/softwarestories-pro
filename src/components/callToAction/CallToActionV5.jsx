...
import ctaThumb from '/images/call-action/call-action-right.jpg'
                ...
                <div className="container">
                    <Fade className="fadeInUp" delay={300}>
                        <div className="call-action-four rel z-1 p-70 pb-80 rpx-55" style={{ backgroundImage: "url(/images/call-action/call-action-bg.png)" }}>
                            ...
                            <h2>Truly, Madly, Deeply committed to delivering exceptional software solutions.</h2>
                              </div>
                  <Link to="/contact#" className="theme-btn style-twelve">Connect with Us</Link>
