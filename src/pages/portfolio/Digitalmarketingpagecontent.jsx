...
import portfolioDetails from "/images/gallery/dig4.png";
import portfolioThumb1 from "/images/gallery/dig2.jpg";
import portfolioThumb2 from "/images/gallery/dig3.jpg";
...
const DigitalmarketingpageContent = () => {
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-8">
              <div className="portfolio-details-content rmb-55">
                ...
                <p>
                The focus of Software Stories LTD is to provide effective digital marketing solutions, including SEO, social media management, PPC, and content strategy. We help businesses to grow their online presence and engage with the audience meaningfully. Our team of creative marketers and strategists then formulates data-centric campaigns designed with your brand and goals in mind. Whether boosting visibility, generating leads, or building an 
                active online community, we can help accomplish that the smart way. Let's grow your brand!
                </p>
